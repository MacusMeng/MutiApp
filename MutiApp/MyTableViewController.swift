...
class MyTableViewController: UITableViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = UITableViewCell(style: UITableViewCellStyle.Default , reuseIdentifier: identiString)
        cell.textLabel?.text = girlsNames[indexPath.row]
        let imageNames = girlsPictures[indexPath.row]
        cell.imageView?.image = UIImage(named: imageNames)
        return cell
    }
